...
[WARNING] in /home/mintymike/public_html/refresh-sf.com/public/yui/files/95ff0ecfbee7c8097e1ae1983f719c7276c84086.txt
  Try to use a single 'var' statement per scope.
.call(element,selector);} ---> var  <--- match,parent=element.parentNode,temp=

[WARNING] in /home/mintymike/public_html/refresh-sf.com/public/yui/files/95ff0ecfbee7c8097e1ae1983f719c7276c84086.txt
  Try to use a single 'var' statement per scope.
);}});}else{ ---> var  <--- excludes=typeofselector=="string"?this.filter

[WARNING] in /home/mintymike/public_html/refresh-sf.com/public/yui/files/95ff0ecfbee7c8097e1ae1983f719c7276c84086.txt
  Try to use a single 'var' statement per scope.
this[0]&&!func){ ---> var  <--- dom=$(structure).get(0

[WARNING] in /home/mintymike/public_html/refresh-sf.com/public/yui/files/95ff0ecfbee7c8097e1ae1983f719c7276c84086.txt
  Try to use a single 'var' statement per scope.
getDelegate&&getDelegate(fn,event); ---> var  <--- callback=handler.del||fn;handler.
