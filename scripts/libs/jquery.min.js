...
[WARNING] in /home/mintymike/public_html/refresh-sf.com/public/yui/files/ec694a19420d56ed6b20f87a3e5f4eced5725f30.txt
  Try to use a single 'var' statement per scope.
;}rootjQuery=jQuery(document); ---> var  <--- optionsCache={};functioncreateOptions(options)

[WARNING] in /home/mintymike/public_html/refresh-sf.com/public/yui/files/ec694a19420d56ed6b20f87a3e5f4eced5725f30.txt
  Try to use a single 'var' statement per scope.
;returnsupport;})(); ---> var  <--- rbrace=/(?:\{[\s\S]*\}|\[[\s\S]*\])$/,rmultiDash=/([A-Z])/g;functioninternalData

[WARNING] in /home/mintymike/public_html/refresh-sf.com/public/yui/files/ec694a19420d56ed6b20f87a3e5f4eced5725f30.txt
  Try to use a single 'var' statement per scope.
promise(obj);}}); ---> var  <--- nodeHook,boolHook,rclass=/[\t\r\n]/g,rreturn=
...
[WARNING] in /home/mintymike/public_html/refresh-sf.com/public/yui/files/ec694a19420d56ed6b20f87a3e5f4eced5725f30.txt
  Try to use a single 'var' statement per scope.
));}}returnsafeFrag;} ---> var  <--- nodeNames="abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",rinlinejQuery=/ jQuery\d+="(?:null|\d+)"/g,rnoshimcache=
...
[WARNING] in /home/mintymike/public_html/refresh-sf.com/public/yui/files/ec694a19420d56ed6b20f87a3e5f4eced5725f30.txt
  Try to use a single 'var' statement per scope.
mouseleave(fnOut||fnOver);}; ---> var  <--- ajaxLocParts,ajaxLocation,ajax_nonce=jQuery.now(

[WARNING] in /home/mintymike/public_html/refresh-sf.com/public/yui/files/ec694a19420d56ed6b20f87a3e5f4eced5725f30.txt
  Try to use a single 'var' statement per scope.
;}}};}}); ---> var  <--- oldCallbacks=[],rjsonp=/(=)\?(?=&|$)|\?\?/;jQuery

[WARNING] in /home/mintymike/public_html/refresh-sf.com/public/yui/files/ec694a19420d56ed6b20f87a3e5f4eced5725f30.txt
  Try to use a single 'var' statement per scope.
);return"script";}}); ---> var  <--- xhrCallbacks,xhrSupported,xhrId=0,xhrOnUnloadAbort=
